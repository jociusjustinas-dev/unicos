...
export function BrandShowcaseCard({
  ...
  return (
    <article
      ...
      className={`group/card flex flex-col border border-[#1A1010]/10 bg-white/40 text-[#1A1010] transition-[transform,border-color] duration-500 ease-in-out hover:-translate-y-[1px] hover:border-[#64151F]/20 ${className}`}
      ...
      <div className="flex flex-col gap-4 p-6 max-[767px]:p-5">
        <div className="flex min-h-8 items-center">
          {logoSvg ? (
            ...
            <h3 className="m-0 text-[#1A1010]" style={{ ...BODY, fontSize: '22px', lineHeight: 1.2, fontWeight: 500 }}>
              {title}
            </h3>
          )}
        </div>
