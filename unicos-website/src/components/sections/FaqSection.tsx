                ...
                >
                  ...
                  >
                    ...
                    <span className="relative mt-1 flex h-3 w-3 shrink-0 items-center justify-center" aria-hidden>
                      ...
                      <span
                        className="absolute h-3 w-px bg-[#1A1010] transition-transform duration-300 ease-out"
                        style={{
                          left: '50%',
                          marginLeft: '-0.5px',
                  ...
                  <div
                    ...
                    className={`overflow-hidden transition-[max-height,opacity,transform] duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] ${
                      isOpen ? 'max-h-[min(760px,82vh)] opacity-100 translate-y-0' : 'max-h-0 opacity-0 -translate-y-1'
                    }`}
                  >
                    <p
