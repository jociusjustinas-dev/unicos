...
export function TapkitePartneriuHeroSection() {
  ...
  const testimonialStyle: React.CSSProperties = {
    ...
    transition:
      'opacity 0.9s cubic-bezier(0.22,1,0.36,1) 180ms, filter 0.9s cubic-bezier(0.22,1,0.36,1) 180ms, transform 0.9s cubic-bezier(0.22,1,0.36,1) 180ms',
  };
  ...
  const formStyle: React.CSSProperties = {
    ...
    transition:
      'opacity 0.9s cubic-bezier(0.22,1,0.36,1) 120ms, filter 0.9s cubic-bezier(0.22,1,0.36,1) 120ms, transform 0.9s cubic-bezier(0.22,1,0.36,1) 120ms',
  };
      ...
      <div className="mx-auto w-full max-w-[1800px] px-16 max-[767px]:px-6 max-[479px]:px-4">
        <div className="grid grid-cols-2 gap-x-[min(8rem,6vw)] gap-y-16 max-[991px]:grid-cols-1 max-[991px]:gap-y-12 max-[767px]:gap-y-10">
          ...
          <div className="flex flex-col items-start gap-8 max-w-[564px] max-[991px]:max-w-none max-[991px]:flex-row max-[991px]:items-end max-[991px]:justify-between max-[767px]:flex-col max-[767px]:items-stretch max-[767px]:gap-6">
            <div ref={topRef} style={topStyle} className="flex flex-col items-start gap-6 max-[767px]:gap-4 transition-all duration-[900ms] ease-[cubic-bezier(0.22,1,0.36,1)] max-[991px]:max-w-[448px] max-[479px]:max-w-[364px]">
            ...
            <div
              ...
              className="w-full transition-all duration-[900ms] ease-[cubic-bezier(0.22,1,0.36,1)]"
            >
              <div
          ...
          {/* RIGHT COLUMN: FORM */}
          <div ref={formRef} style={formStyle} className="transition-all duration-[900ms] ease-[cubic-bezier(0.22,1,0.36,1)] max-[991px]:w-full">
            <div
