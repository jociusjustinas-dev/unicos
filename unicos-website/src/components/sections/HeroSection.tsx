  ...
  return (
    ...
    >
      <div className="relative z-[2] w-full max-w-[1800px] mx-auto px-16 max-[767px]:px-6 max-[479px]:px-4">
        <div
          ref={headlineRef}
          className={`max-w-[680px] mx-auto mb-12 flex flex-col items-center text-center gap-6 max-[767px]:gap-4 max-[767px]:mb-8 transition-all duration-700 ease-out ${
        ...
        <div
          ref={gridRef}
          className={`grid gap-4 max-[767px]:gap-3 transition-all duration-700 ease-out ${
